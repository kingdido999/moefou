...
class Moefou {
  ...
  _get (base, url, parameters, callback) {
    ...
    request.get({
      ...
      if (!error) {
        // Additional error handling for body
        if (typeof body == 'string') {
          // Some APIs may return just a string with no actual data,
          // which is Moefou's problem.
          error = new Error('No response was returned. This is likely a problem of Moefou API.')
        } else {
          // Check if the response contains error. Because there are typos
          // 'infomation' in some APIs' response, we need to check both case
          if ('information' in body.response && body.response.information.has_error) {
            error = new Error(body.response.information.msg)
          } else if ('infomation' in body.response && body.response.infomation.has_error) {
            error = new Error(body.response.infomation.msg)
          }
        }
      }
  ...
  _getGeneral (url, parameters, callback) {
    this._get(GENERAL_API_URL, url, parameters, callback)
  }

  // 专用接口
  _getSpecial (url, parameters, callback) {
    this._get(SPECIAL_API_URL, url, parameters, callback)
  }
  ...
  wikis (wiki_type, optionals, callback) {
    this._getGeneral('wikis', extend({ wiki_type: wiki_type }, optionals), callback)
  }
  ...
  onAir (optionals, callback) {
    this._getGeneral('on-air', optionals, callback)
  }
  ...
  wikiDetail (wiki_type, optionals, callback) {
    this._getGeneral(wiki_type + '/detail', optionals, callback)
  }
  ...
  wikiSubs (wiki_type, optionals, callback) {
    this._getGeneral(wiki_type + '/subs', optionals, callback)
  }
  ...
  wikiFavs (wiki_type, optionals, callback) {
    this._getGeneral(wiki_type + '/favs', optionals, callback)
  }
  ...
  wikiRatings (wiki_type, optionals, callback) {
    this._getGeneral(wiki_type + '/ratings', optionals, callback)
  }
  ...
  wikiRelationships (wiki_type, optionals, callback) {
    this._getGeneral(wiki_type + '/relationships', optionals, callback)
  }
  ...
  wikiSimilarity (wiki_type, optionals, callback) {
    this._getGeneral(wiki_type + '/similarity', optionals, callback)
  }
  ...
  subDetail (sub_type, sub_id, callback) {
    this._getGeneral(sub_type + '/detail', { sub_id: sub_id }, callback)
  }
  ...
  subRelationships (sub_type, sub_id, optionals, callback) {
    this._getGeneral(sub_type + '/relationships', extend({ sub_id: sub_id }, optionals), callback)
  }
  ...
  userDetail (optionals, callback) {
    this._getGeneral('user/detail', optionals, callback)
  }
  ...
  userFavsWiki (optionals, callback) {
    this._getGeneral('user/favs/wiki', optionals, callback)
  }
  ...
  userFavsSub (optionals, callback) {
    this._getGeneral('user/favs/sub', optionals, callback)
  }
  ...
  listenPlaylist (optionals, callback) {
    this._getSpecial('listen/playlist', extend({ api: 'json' }, optionals), callback)
  }
  ...
  explore (optionals, callback) {
    this._getSpecial('explore', extend({ api: 'json' }, optionals), callback)
  }
  ...
  music (wiki_id, callback) {
    this._getSpecial('music/' + wiki_id, { api: 'json' }, callback)
  }
  ...
  musicSongs (wiki_id, callback) {
    this._getSpecial('music/' + wiki_id + '/songs', { api: 'json' }, callback)
  }
  ...
  musicFavs (wiki_id, callback) {
    this._getSpecial('music/' + wiki_id + '/favs', { api: 'json' }, callback)
  }
}
